...
Source Code
===========
See the source code for method [LightKitDebugTraceService::isAcceptedRequest](https://github.com/lingtalfi/Light_Kit_DebugTrace/blob/master/Service/LightKitDebugTraceService.php#L369-L372)
