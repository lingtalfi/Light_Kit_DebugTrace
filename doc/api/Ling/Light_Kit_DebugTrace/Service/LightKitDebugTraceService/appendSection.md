...
Source Code
===========
See the source code for method [LightKitDebugTraceService::appendSection](https://github.com/lingtalfi/Light_Kit_DebugTrace/blob/master/Service/LightKitDebugTraceService.php#L310-L325)
