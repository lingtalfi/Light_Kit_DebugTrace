...
Source Code
===========
See the source code for method [LightKitDebugTraceService::setTargetFile](https://github.com/lingtalfi/Light_Kit_DebugTrace/blob/master/Service/LightKitDebugTraceService.php#L258-L261)
