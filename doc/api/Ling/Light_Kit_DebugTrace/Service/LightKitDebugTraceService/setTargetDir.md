...
Source Code
===========
See the source code for method [LightKitDebugTraceService::setTargetDir](https://github.com/lingtalfi/Light_Kit_DebugTrace/blob/master/Service/LightKitDebugTraceService.php#L268-L271)
